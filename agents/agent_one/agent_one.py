...
MIN_ACTIVE_BALANCE_SATS = int(os.getenv("AGENT_ONE_MIN_BALANCE_SATS", "1500"))
FIRST_BUY_MAX_SATS = int(os.getenv("AGENT_ONE_FIRST_BUY_MAX_SATS", "1500"))
NORMAL_BUY_MIN_SATS = int(os.getenv("AGENT_ONE_NORMAL_BUY_MIN_SATS", "500"))
NORMAL_BUY_MAX_SATS = int(os.getenv("AGENT_ONE_NORMAL_BUY_MAX_SATS", "2000"))
DAILY_BUY_LIMIT = int(os.getenv("AGENT_ONE_DAILY_BUY_LIMIT", "5"))
DAILY_SPEND_CAP_SATS = int(os.getenv("AGENT_ONE_DAILY_SPEND_CAP_SATS", "8000"))
BUY_INTERVAL_SECONDS = int(os.getenv("AGENT_ONE_BUY_INTERVAL_SECONDS", "5400"))
