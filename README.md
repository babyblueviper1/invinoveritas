...
| `POST /ledger/submit` | 150 sats — propose your own `/review(sign=true)` proof as a featured public ledger entry; publishes immediately, no human review (the cryptographic check against our own key IS the gate) |
